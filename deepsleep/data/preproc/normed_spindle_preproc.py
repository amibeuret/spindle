...
class NormalisedSpindlePreproc:
    ...
    def __call__(self, all_signals, srate,
        ...
        specs = [eeg_spectrograms, emg_spectrogram]
    ...
    def __str__(self):
        return f"""Preprocessing class NormalisedSpindlePreprocessing 
        replicates the  preprocessing introduced in the paper where the 
        original normalisation is replaced with Linus normalisation.
        parameters:
